...
const RequestSecsion = () => {
	...
	return (
		<div className="flex flex-col justify-start items-start gap-2 w-full h-full min-w-0 duration-150">
			...
			<div className="w-full h-full bg-(--primary-border) border border-(--primary-border) grid grid-rows-[38px_1fr] gap-px ">
						...
						<div className="w-[50%] min-h-full sticky top-0 right-0">
							<div className="w-full h-full bg-(--primary-bg)   border border-(--primary-border) flex flex-col justify-start items-start gap-1 px-3 py-4">
								...
								<button
									...
									className="bg-(--highlight-color) text-(--primary-text) text-xs text-center rounded-sm px-6 py-2 mt-2 hover:scale-105 hover:duration-150 hover:transition-all cursor-pointer"
								>
									Send request
								</button>
							</div>
